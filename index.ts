...
export { ClaudeHookBridge, DEFAULT_TOOL_RESOURCE_MAP } from './lib/claude-hooks';
export type { ClaudeHookBridgeOptions, ClaudeHookInput, ClaudeHookEvent, HookPermissionDecision, PreToolUseHookOutput, HookAuditEntry } from './lib/claude-hooks';
export { createElicitationApprovalCallback, StdioElicitationChannel } from './lib/mcp-elicitation';
