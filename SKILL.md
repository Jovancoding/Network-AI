...
| Control | How Network-AI addresses it |
|---|---|
| **Exact version pinning** | npm `package.json` uses exact `"version": "5.8.7"` — no semver range specifiers; `clawhub install network-ai` pins to a specific published version |
