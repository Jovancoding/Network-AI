...
Network-AI is a TypeScript/Node.js multi-agent orchestrator — shared state, guardrails, budgets, and cross-framework coordination (v5.6.0). 3,136 tests across 31 suites.
...
npm run test:all              # All 3,136 tests across 31 suites
