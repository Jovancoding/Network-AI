...
### Fixed
- **ClawHub display name** — corrected to "Network-AI" (5.13.2 used the wrong internal name "SwarmOrchestrator").

## [5.13.2] - 2026-06-26

### Fixed
- **ClawHub display name** — republish to correct skill display name to "SwarmOrchestrator" (5.13.1 was published from a temp staging directory whose folder name was incorrectly used as the display name).
